...
<div id="page">
	<div id='tabs'>
            <a href='forge.php?type=armor' >Zbroje</a>
            <a href='forge.php?type=shield' >Tarcze</a>
   	      <a href='forge.php?type=weapon_melee_1' >Broń Jednoręczna</a>
   	      <a href='forge.php?type=weapon_melee_2' >Broń Dwuręczna</a>
   	      <a href='forge.php?type=weapon_ranged' >Broń Dystansowa</a><br>
      ...
      <?php
		...
		$pdo -> setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
   	      ...
   	      if($type == 'armor')
            {
                  show_armor($pdo, $_SESSION['hero'], '../../../', array('level'), array('Poziom'), array('value_improve'), array('Cena Ulepszenia'), 0, array('improve.php', 'repare.php'), array('Ulepsz', 'Napraw'), $_SESSION['hero']['armor'], '', 'Założone', 'chance_improve', array('Szanse na ulepszenie'));
   		}
   		else if($type == 'shield')
   		{
